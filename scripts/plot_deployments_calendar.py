...
def main(args):
    """
    Search the IOOS Glider DAC for data sets matching the search criteria and plot the deployments calendar. Calendar is
    ...
    if plot_type == 'ymd':
        ...
        logging.info('Plotting year,month,day deployments calendar')
        ...
        calendar = client.ymd_deployments_calendar
        ...
        ax.set_title('{:} Deployments ({:}): {:} - {:}'.format(title,
                                                               datasets.shape[0],
        ...
        logging.info('Plotting year,month deployments calendar')
